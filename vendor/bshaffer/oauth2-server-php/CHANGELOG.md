...
* 1.4 (2014-06-12)
  ...
  * bug #323 RocketchatResourceController - client_id is no longer required to be returned when calling getAccessToken
...
* 1.0 (2013-08-12)
  ...
  * bug #203 Add redirect\_status_code config param for RocketchatAuthorizeController
  ...
  * bug #162 adds getToken on RocketchatResourceController for convenience
