 ...
 *
 *  ex:
 *  > if (!$RocketchatResourceController->verifyResourceRequest(OAuth2\Request::createFromGlobals(), $response = new OAuth2\Response())) {
 ...
 *
 */
interface RocketchatResourceControllerInterface
{
