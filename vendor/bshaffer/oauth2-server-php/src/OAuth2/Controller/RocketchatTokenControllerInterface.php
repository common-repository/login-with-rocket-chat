 ...
 *
 *  ex:
 *  > $RocketchatTokenController->handleTokenRequest(OAuth2\Request::createFromGlobals(), $response = new OAuth2\Response());
 *  > $response->send();
 *
 */
interface RocketchatTokenControllerInterface
{
    /**
     * handleTokenRequest
     *
