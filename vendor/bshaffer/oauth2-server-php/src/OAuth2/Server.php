...
use OAuth2\Controller\RocketchatResourceControllerInterface;
use OAuth2\Controller\RocketchatResourceController;
use OAuth2\OpenID\Controller\UserInfoControllerInterface;
use OAuth2\OpenID\Controller\UserInfoController;
use OAuth2\OpenID\Controller\RocketchatAuthorizeController as OpenIDRocketchatAuthorizeController;
...
use OAuth2\Controller\RocketchatAuthorizeControllerInterface;
use OAuth2\Controller\RocketchatAuthorizeController;
use OAuth2\Controller\RocketchatTokenControllerInterface;
use OAuth2\Controller\RocketchatTokenController;
...
*
* @see OAuth2\Controller\RocketchatResourceController
* @see OAuth2\Controller\RocketchatAuthorizeController
* @see OAuth2\Controller\RocketchatTokenController
*/
class Server implements RocketchatResourceControllerInterface,
    RocketchatAuthorizeControllerInterface,
    RocketchatTokenControllerInterface,
    UserInfoControllerInterface
{
    ...
    // servers
    protected $RocketchatAuthorizeController;
    protected $RocketchatTokenController;
    protected $RocketchatResourceController;
    ...
    public function getRocketchatAuthorizeController()
    {
        if (is_null($this->RocketchatAuthorizeController)) {
            $this->RocketchatAuthorizeController = $this->createDefaultRocketchatAuthorizeController();
        }

        return $this->RocketchatAuthorizeController;
    }

    public function getRocketchatTokenController()
    {
        if (is_null($this->RocketchatTokenController)) {
            $this->RocketchatTokenController = $this->createDefaultRocketchatTokenController();
        }

        return $this->RocketchatTokenController;
    }

    public function getRocketchatResourceController()
    {
        if (is_null($this->RocketchatResourceController)) {
            $this->RocketchatResourceController = $this->createDefaultRocketchatResourceController();
        }

        return $this->RocketchatResourceController;
    }
     ...
     */
    public function setRocketchatAuthorizeController(RocketchatAuthorizeControllerInterface $RocketchatAuthorizeController)
    {
        $this->RocketchatAuthorizeController = $RocketchatAuthorizeController;
    }

    /**
     * every getter deserves a setter
     */
    public function setRocketchatTokenController(RocketchatTokenControllerInterface $RocketchatTokenController)
    {
        $this->RocketchatTokenController = $RocketchatTokenController;
    }

    /**
     * every getter deserves a setter
     */
    public function setRocketchatResourceController(RocketchatResourceControllerInterface $RocketchatResourceController)
    {
        $this->RocketchatResourceController = $RocketchatResourceController;
    }
    ...
    {
        $this->response = is_null($response) ? new Response() : $response;
        $this->getRocketchatTokenController()->handleTokenRequest($request, $this->response);
        return $this->response;
    }
    ...
    {
        $this->response = is_null($response) ? new Response() : $response;
        $value = $this->getRocketchatTokenController()->grantAccessToken($request, $this->response);
    ...
    {
        $this->response = is_null($response) ? new Response() : $response;
        $this->getRocketchatTokenController()->handleRevokeRequest($request, $this->response);
    ...
    public function handleAuthorizeRequest(RequestInterface $request, ResponseInterface $response, $is_authorized, $user_id = null)
    {
        ...
        $this->getRocketchatAuthorizeController()->handleAuthorizeRequest($request, $this->response, $is_authorized, $user_id);
    ...
    {
        $this->response = is_null($response) ? new Response() : $response;
        $value = $this->getRocketchatAuthorizeController()->validateAuthorizeRequest($request, $this->response);
    ...
    {
        $this->response = is_null($response) ? new Response() : $response;
        $value = $this->getRocketchatResourceController()->verifyResourceRequest($request, $this->response, $scope);
    ...
    {
        $this->response = is_null($response) ? new Response() : $response;
        $value = $this->getRocketchatResourceController()->getAccessTokenData($request, $this->response);
    ...
    public function addGrantType(GrantTypeInterface $grantType, $identifier = null)
    {
        ...
        // persist added grant type down to RocketchatTokenController
        if (!is_null($this->RocketchatTokenController)) {
            $this->getRocketchatTokenController()->addGrantType($grantType, $identifier);
        }
    }
    ...
    protected function createDefaultRocketchatAuthorizeController()
    {
        ...
        if ($this->config['use_openid_connect']) {
            return new OpenIDRocketchatAuthorizeController($this->storages['client'], $this->responseTypes, $config, $this->getScopeUtil());
        }

        return new RocketchatAuthorizeController($this->storages['client'], $this->responseTypes, $config, $this->getScopeUtil());
    }

    protected function createDefaultRocketchatTokenController()
    {
        ...
        return new RocketchatTokenController($accessTokenResponseType, $this->storages['client'], $this->grantTypes, $this->clientAssertionType, $this->getScopeUtil());
    }

    protected function createDefaultRocketchatResourceController()
    {
        ...
        return new RocketchatResourceController($this->tokenType, $this->storages['access_token'], $config, $this->getScopeUtil());
    }
