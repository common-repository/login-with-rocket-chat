...
use OAuth2\Controller\RocketchatAuthorizeController as BaseRocketchatAuthorizeController;
use OAuth2\RequestInterface;
use OAuth2\ResponseInterface;

/**
 * @see OAuth2\Controller\RocketchatAuthorizeControllerInterface
 */
class RocketchatAuthorizeController extends BaseRocketchatAuthorizeController implements RocketchatAuthorizeControllerInterface
{
    private $nonce;
